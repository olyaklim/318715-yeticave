  ...
  <form class="form container<?php echo ($errors) ? " form--invalid" : "" ?>" action="/sign-up.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    ...
    <div class="form__item form__item--file form__item--last <?php echo (isset($errors['file'])) ? " form__item--invalid " : "" ?> <?php echo (isset($user['user_img'])) ? " form__item--uploaded" : "" ?>">
      ...
      <div class="preview">
        ...
        <div class="preview__img">
          <img src="<?php echo $user['user_img'];?>" width="113" height="113" alt="Ваш аватар">
        </div>
      </div>
      <div class="form__input-file">
        <input class="visually-hidden" type="file" id="photo2" value="<?php echo $user['user_img'];?>" name="user_img">
        <label for="photo2">
          <span>+ Добавить</span>
        </label>
      </div>
